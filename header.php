                                            ...
                                            <ul class="nav navbar-nav mai-top-nav header-right-menu">
                                                ...
                                                <li class="nav-item">
                                                    ...
                                                    <ul role="menu" class="dropdown-header-top author-log dropdown-menu animated zoomIn">
                                                        ...
                                                        <li><a href="old_exam_result.php"><span class="edu-icon edu-settings author-log-ic"></span>old exam result</a>
                                                        </li>
...
setInterval(function(){
  ...
  xhttp.open("GET", "forajax/load_timer.php", true);
  xhttp.send(null);
	}
</script>
